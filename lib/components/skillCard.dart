          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                subtitle: Hero(
                    tag: 'skill_${skill.name}_description',
                    child: getDescriptionWidget(context, skill.description,
...
Widget getDescriptionWidget(
    BuildContext context, List<String> description, textStyle) {
  switch (description.length) {
    case 0:
      return Text('');
    case 1:
      return Text(description.first, style: textStyle);
    default:
      return BulletList(
        texts: description,
        textStyle: textStyle,
