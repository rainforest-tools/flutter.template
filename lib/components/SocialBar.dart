...
class _SocialBarState extends State<SocialBar> {
  ...
  Widget build(BuildContext context) {
    _floatingButton = AnimatedContainer(
      ...
      child: Transform.rotate(
        ...
        child: InkWell(
          ...
          child: SizedBox(width: 56, height: 56, child: Icon(_isCollapsed ? Icons.message : Icons.cancel)),
          onTap: () => setState(() {
    ...
    return Material(
      ...
      color: widget.isCollapsable ? Theme.of(context).accentColor : Colors.transparent,
